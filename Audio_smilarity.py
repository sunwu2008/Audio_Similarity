...
# Main execution
def main(full_mp3_path, sample_mp3_path, similarity_percent, log_file="match_log.txt"):
    ...
    matches = match_segments(full_audio, sample_audio, step_ms=50, similarity_threshold=similarity_threshold)
...
if __name__ == "__main__":
    ...
    main(args.input, args.reference, args.similarity)
